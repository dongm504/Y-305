...
static	unsigned int ISR1			@0X0E:rpage 0;//interrupt status register  and wake up control1
static	unsigned int WUCR1			@0X0E:rpage 0;//interrupt status register  and wake up control1
...
static	unsigned int WUCR2			@0X0E:rpage 1;//Wake up Control Register2
...
static	io unsigned int DeadTCR     @0x09:iopage 1;//Dead time control register
static	io unsigned int DeadTR      @0x0A:iopage 1;//Dead time register
static	io unsigned int PHCR3       @0x0B:iopage 1;//Pull-high Control Register
static	io unsigned int P7PHCR      @0x0B:iopage 1;//Pull-high Control Register
...
//
static	bit VREF1		@0X0A@2:rpage 0;
static	bit VREF0		@0X0A@1:rpage 0;
static	bit ADICS		@0X0A@0:rpage 0;
//
...
static	bit P7ICIF		@0X0F@7:rpage 0;
...
static 	bit TRS 		@0X05@6:rpage 1;
static 	bit Rbit11		@0X05@3:rpage 1;
...
static 	bit IPWM2E 		@0X07@7:rpage 1;
static 	bit IPWM1E 		@0X07@6:rpage 1;
